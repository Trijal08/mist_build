...
ifneq ($(MIST_BUILD),)
include vendor/mist/config/BoardConfigMist.mk
endif
...
ifneq ($(MIST_BUILD),)
ifneq ($(wildcard device/mist/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/mist/sepolicy/common/sepolicy.mk)
endif
endif
